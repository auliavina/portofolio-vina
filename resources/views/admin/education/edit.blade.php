                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="tempat_pend" value="{{ $educations->tempat_pend }}"
                                        class="form-control" placeholder="Input tempat menunjang pendidikan">
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                                    <strong>Tahun</strong>
                                    <input type="text" name="tahun" value="{{ $educations->tahun }}"
